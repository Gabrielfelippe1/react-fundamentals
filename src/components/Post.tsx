...
export function Post({author, publishedAt, content} : PostProps) {
  ...
  const publisehDateRelativeToNow = formatDistanceToNow(publishedAt, {
    locale: ptBR,
    addSuffix: true
  ...
  return (
    <article className={styles.post}>
      <header>
        ...
        <time title={publishedDateFormated} dateTime={publishedAt.toISOString()}>{publisehDateRelativeToNow}</time>
      </header>
